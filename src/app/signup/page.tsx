...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-200 via-white to-blue-100 dark:from-zinc-900 dark:via-zinc-950 dark:to-blue-900">
      <form onSubmit={handleSignup} className="bg-white/90 dark:bg-zinc-900/90 p-10 rounded-3xl shadow-2xl w-full max-w-md flex flex-col gap-7 border border-zinc-200 dark:border-zinc-800 backdrop-blur">
        <h1 className="text-4xl font-extrabold text-center mb-2 text-blue-700 dark:text-blue-200 tracking-tight drop-shadow">Create Account</h1>
        <p className="text-center text-zinc-500 dark:text-zinc-400 mb-2 text-base">Sign up to get started</p>
